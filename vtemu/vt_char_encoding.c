 ...
 */
static u_int16_t /* ef_charset_t */ msb_set_cs_table[] = {
...
/* 0x21 - 0x7e */
static u_int16_t dectech_to_ucs_table[] = {
  ...
  0x03A0, 0x03A8, 0x0,    0x03A3, 0x0,    0x0,    0x221A, 0x03A9,
  0x039E, 0x03A5, 0x2282, 0x2283, 0x2229, 0x222A, 0x2227, 0x2228,
  0x00AC, 0x03B1, 0x03B2, 0x03C7, 0x03B4, 0x03B5, 0x03C6, 0x03B3,
  0x03B7, 0x03B9, 0x03B8, 0x03BA, 0x03BB, 0x0,    0x03BD, 0x2202,
  0x03C0, 0x03C8, 0x03C1, 0x03C3, 0x03C4, 0x0,    0x0192, 0x03C9,
...
/* XXX This function should be moved to mef */
u_int16_t vt_convert_dectech_to_ucs(u_char dectech) {
  if (0x21 <= dectech && dectech <= 0x7e) {
    return dectech_to_ucs_table[dectech - 0x21];
  }
