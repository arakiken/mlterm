...
#define vt_screen_cursor_row(screen) vt_cursor_row((screen)->edit)

#define vt_screen_cursor_relative_col(screen) vt_cursor_relative_col((screen)->edit)

#define vt_screen_cursor_relative_row(screen) vt_cursor_relative_row((screen)->edit)

int vt_screen_cursor_row_in_screen(vt_screen_t *screen);

#define vt_screen_get_cols(screen) vt_edit_get_cols((screen)->edit)

#define vt_screen_get_rows(screen) vt_edit_get_rows((screen)->edit)
