	...
	)
{
	...
	kik_remove_sig_child_listener( config_menu) ;
...
x_config_menu_start(
	...
	x_mod_meta_mode_t  orig_mod_meta_mode ,
	x_bel_mode_t  orig_bel_mode ,
	ml_vertical_mode_t  orig_vertical_mode ,
	x_sb_mode_t  orig_sb_mode ,
	...
	x_font_present_t  orig_font_present ,
	...
	)
{
	...
	if( ( config_menu->session = malloc( sizeof( x_config_menu_session_t))) == NULL)
	{
		return  0 ;
	}
