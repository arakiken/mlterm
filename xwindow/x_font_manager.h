...
void  x_font_manager_set_attr( x_font_manager_t *  font_man , int  size_attr , int  use_ot_layout) ;
...
int  x_set_use_italic_font( x_font_manager_t *  font_man , int  use_italic_font) ;
