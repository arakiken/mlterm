	...
	)
{
	...
	{
		x_load_rgb_xcolor( display, screen, xcolor, 0, 0, 0) ;
	}
	else if( strcmp( name, "red") == 0)
	{
		x_load_rgb_xcolor( display, screen, xcolor, 255, 0, 0) ;
	}
	else if( strcmp( name, "green") == 0)
	{
		x_load_rgb_xcolor( display, screen, xcolor, 0, 255, 0) ;
	}
	else if( strcmp( name, "yellow") == 0)
	{
		x_load_rgb_xcolor( display, screen, xcolor, 255, 255, 0) ;
	}
	else if( strcmp( name, "blue") == 0)
	{
		x_load_rgb_xcolor( display, screen, xcolor, 0, 0, 255) ;
	}
	else if( strcmp( name, "magenta") == 0)
	{
		x_load_rgb_xcolor( display, screen, xcolor, 255, 0, 255) ;
	}
	else if( strcmp( name, "cyan") == 0)
	{
		x_load_rgb_xcolor( display, screen, xcolor, 0, 255, 255) ;
	}
	else if( strcmp( name, "white") == 0)
	{
		x_load_rgb_xcolor( display, screen, xcolor, 255, 255, 255) ;
	}
	else
	{
		return  0 ;
