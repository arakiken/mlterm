...
/*
 * XXX
 * jisx0201_kata msb bit is 0 in mkf and is 94 sb charset(excluding space 0x20 and delete 0x7f).
 */

/* --- global functions --- */

int
mkf_map_jisx0201_kata_to_ucs4(
	mkf_char_t *  ucs4 ,
	u_int16_t  jis
	)
{
...
int
mkf_map_jisx0201_roman_to_ucs4(
	mkf_char_t *  ucs4 ,
	u_int16_t  jis
	)
{
