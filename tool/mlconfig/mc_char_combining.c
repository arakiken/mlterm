	...
	)
{
	...
	if( is_checked)
	{
		kik_debug_printf( KIK_DEBUG_TAG " char combining on.\n") ;
	}
	else
	{
		kik_debug_printf( KIK_DEBUG_TAG " char combining off.\n") ;
	}
#endif
...
GtkWidget *
mc_char_combining_config_widget_new(
