...
#define GTK_XLFD_SELECTION_CLASS(klass) \
  (GTK_CHECK_CLASS_CAST((klass), GTK_TYPE_XLFD_SELECTION, GtkXlfdSelectionClass))
...
#define GTK_XLFD_SELECTION_DIALOG(obj) \
  (GTK_CHECK_CAST((obj), GTK_TYPE_XLFD_SELECTION_DIALOG, GtkXlfdSelectionDialog))
#define GTK_XLFD_SELECTION_DIALOG_CLASS(klass) \
  (GTK_CHECK_CLASS_CAST((klass), GTK_TYPE_XLFD_SELECTION_DIALOG, GtkXlfdSelectionDialogClass))
...
#define GTK_IS_XLFD_SELECTION_DIALOG_CLASS(klass) \
  (GTK_CHECK_CLASS_TYPE((klass), GTK_TYPE_XLFD_SELECTION_DIALOG))
...
typedef enum { GTK_XLFD_METRIC_PIXELS, GTK_XLFD_METRIC_POINTS } GtkXlfdMetricType;
...
typedef enum { GTK_XLFD_FILTER_BASE, GTK_XLFD_FILTER_USER } GtkXlfdFilterType;
