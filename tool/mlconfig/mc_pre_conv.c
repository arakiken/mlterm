	...
	)
{
	...
	if( is_checked)
	{
		kik_debug_printf( KIK_DEBUG_TAG " pre conv on.\n") ;
	}
	else
	{
		kik_debug_printf( KIK_DEBUG_TAG " pre conv off.\n") ;
	}
#endif
...
int
mc_is_pre_conv_xct_to_ucs(void)
{
	return  is_checked ;
}
