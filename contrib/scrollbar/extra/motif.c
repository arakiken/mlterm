	...
	)
{
	...
	if( motif_sb->is_transparent)
	{
		...
		motif_sb->fg_darker_color = motif_sb->bg_darker_color =
		    BlackPixel( view->display , view->screen) ;
		return ;
	}

	/* query current fg/bg color pixel */
	XGetGCValues( view->display , view->gc , GCForeground | GCBackground ,
		&gc_value_ret) ;
	...
	{
		motif_sb->fg_darker_color = BlackPixel( view->display ,
							view->screen) ;
	}
	...
	{
		motif_sb->bg_darker_color = BlackPixel( view->display ,
							 view->screen) ;
	}
}
	...
	)
{
	...
	XClearArea( view->display , view->window ,
		2 , V_MARGIN ,
		WIDTH - 4 , view->height - V_MARGIN * 2 , 0) ;
	...
	XSetForeground( view->display , motif_sb->gc ,
			motif_sb->fg_lighter_color) ;
	line[0].x1 = 2         ; line[0].y1 = bar_top_y ;
	line[0].x2 = WIDTH - 3 ; line[0].y2 = bar_top_y ;
	line[1].x1 = 2         ; line[1].y1 = bar_top_y + 1 ;
	line[1].x2 = WIDTH - 4 ; line[1].y2 = bar_top_y + 1 ;
	line[2].x1 = 2         ; line[2].y1 = bar_top_y + 2 ;
	line[2].x2 = 2         ; line[2].y2 = bar_top_y + bar_height - 1 ;
	line[3].x1 = 3         ; line[3].y1 = bar_top_y + 1 ;
	line[3].x2 = 3         ; line[3].y2 = bar_top_y + bar_height - 2 ;
	XDrawSegments( view->display , view->window , motif_sb->gc ,
			line , 4) ;
	...
	XSetForeground( view->display , motif_sb->gc ,
			motif_sb->fg_darker_color) ;
	line[0].x1 = WIDTH - 3 ; line[0].y1 = bar_top_y + 1 ;
	line[0].x2 = WIDTH - 3 ; line[0].y2 = bar_top_y + bar_height - 1 ;
	line[1].x1 = WIDTH - 4 ; line[1].y1 = bar_top_y + 2 ;
	line[1].x2 = WIDTH - 4 ; line[1].y2 = bar_top_y + bar_height - 1 ;
	line[2].x1 = 4         ; line[2].y1 = bar_top_y + bar_height - 2 ;
	line[2].x2 = WIDTH - 5 ; line[2].y2 = bar_top_y + bar_height - 2 ;
	line[3].x1 = 3         ; line[3].y1 = bar_top_y + bar_height - 1 ;
	line[3].x2 = WIDTH - 5 ; line[3].y2 = bar_top_y + bar_height - 1 ;
	XDrawSegments( view->display , view->window , motif_sb->gc ,
			line , 4) ;
	...
	XSetForeground( view->display , motif_sb->gc ,
			motif_sb->bg_darker_color) ;
	line[0].x1 = 0 ; line[0].y1 = V_MARGIN ;
	line[0].x2 = 0 ; line[0].y2 = view->height - V_MARGIN ;
	line[1].x1 = 1 ; line[1].y1 = V_MARGIN ;
	line[1].x2 = 1 ; line[1].y2 = view->height - V_MARGIN ;
	XDrawSegments( view->display , view->window , motif_sb->gc ,
			line , 2) ;
	...
	XSetForeground( view->display , motif_sb->gc ,
			motif_sb->bg_lighter_color) ;
	line[0].x1 = WIDTH - 2 ; line[0].y1 = V_MARGIN ;
	line[0].x2 = WIDTH - 2 ; line[0].y2 = view->height - V_MARGIN ;
	line[1].x1 = WIDTH - 1 ; line[1].y1 = V_MARGIN ;
	line[1].x2 = WIDTH - 1 ; line[1].y2 = view->height - V_MARGIN ;
	XDrawSegments( view->display , view->window , motif_sb->gc ,
			line , 2) ;
}
...
x_sb_view_t *
x_motif_transparent_sb_view_new(void)
{
	motif_sb_view_t *  motif_sb ;
