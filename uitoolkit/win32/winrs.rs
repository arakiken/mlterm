...
ConnectDialog DIALOG 20, 20, 138, 138
  STYLE WS_POPUP | WS_DLGFRAME | DS_CENTER
  {
    GROUPBOX "Protocol", -1, 4, 4, 126, 24
    RADIOBUTTON "&SSH", IDD_SSH, 8, 14, 40, 12
    RADIOBUTTON "&MOSH", IDD_MOSH, 48, 14, 40, 12
    RADIOBUTTON "&TELNET", IDD_TELNET, 88, 14, 40, 12
    RADIOBUTTON "&RLOGIN", IDD_RLOGIN, 128, 14, 40, 12
