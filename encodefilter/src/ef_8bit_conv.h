...
#ifndef __EF_8BIT_CONV_H__
#define __EF_8BIT_CONV_H__
...
ef_conv_t* ef_iscii_gujarati_conv_new(void);

ef_conv_t* ef_iscii_hindi_conv_new(void);

ef_conv_t* ef_iscii_kannada_conv_new(void);

ef_conv_t* ef_iscii_malayalam_conv_new(void);

ef_conv_t* ef_iscii_oriya_conv_new(void);

ef_conv_t* ef_iscii_punjabi_conv_new(void);

ef_conv_t* ef_iscii_tamil_conv_new(void);

ef_conv_t* ef_iscii_telugu_conv_new(void);
