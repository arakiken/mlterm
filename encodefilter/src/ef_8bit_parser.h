...
#ifndef __EF_8BIT_PARSER_H__
#define __EF_8BIT_PARSER_H__
...
ef_parser_t *ef_iscii_gujarati_parser_new(void);

ef_parser_t *ef_iscii_hindi_parser_new(void);

ef_parser_t *ef_iscii_kannada_parser_new(void);

ef_parser_t *ef_iscii_malayalam_parser_new(void);

ef_parser_t *ef_iscii_oriya_parser_new(void);

ef_parser_t *ef_iscii_punjabi_parser_new(void);

ef_parser_t *ef_iscii_tamil_parser_new(void);

ef_parser_t *ef_iscii_telugu_parser_new(void);
